                                      ...
                                      4 ; This file was generated Sun Aug  4 20:58:55 2019
                                      5 ;--------------------------------------------------------
                                      6 	.module main
                                      7 	.optsdcc -mstm8
                                      8 	
      ...
      0081A0 5B 03            [ 2]  184 	addw	sp, #3
                                    185 ;	src/main.c: 49: Initialise_Uart();
      0081A2 CD 80 E8         [ 4]  186 	call	_Initialise_Uart
                                    187 ;	src/main.c: 53: PORT(LED_PORT, DDR)  |= LED_PIN; // i.e. PB_DDR |= (1 << 5);
      0081A5 AE 50 07         [ 2]  188 	ldw	x, #0x5007
      0081A8 F6               [ 1]  189 	ld	a, (x)
      0081A9 AA 20            [ 1]  190 	or	a, #0x20
      0081AB F7               [ 1]  191 	ld	(x), a
                                    192 ;	src/main.c: 55: PORT(LED_PORT, CR1)  |= LED_PIN; // i.e. PB_CR1 |= (1 << 5);
      0081AC AE 50 08         [ 2]  193 	ldw	x, #0x5008
      0081AF F6               [ 1]  194 	ld	a, (x)
      0081B0 AA 20            [ 1]  195 	or	a, #0x20
      0081B2 F7               [ 1]  196 	ld	(x), a
                                    197 ;	src/main.c: 57: enableInterrupts();
      0081B3 9A               [ 1]  198 	rim
                                    199 ;	src/main.c: 58: while(1) 
      0081B4                        200 00102$:
                                    201 ;	src/main.c: 66: wfi();
      0081B4 8F               [10]  202 	wfi
                                    203 ;	src/main.c: 67: Uart_Printf("Bare metal Programming for STM8 for firmware follow on github\n\r");
